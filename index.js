...
//🚀🚀🚀 ⬇️ 📝 Explanation ⬇️ 📝 🚀🚀🚀: 
//Functions inside myFunction can access anything inside the function but functions outside the function can not "reach in" to access items inside.
...
console.log(`Height: ${cuboidTwo.height}`);
